  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="space-y-8">
        ...
        {/* Metadata Controls (Category, Tags, Thumbnail) */}
        ...
        <div>
          ...
          <input
            ...
            placeholder="A brief 1-2 sentence description for preview cards..."
            className="w-full px-3 py-1.5 text-xs bg-white border border-neutral-200 rounded-md text-neutral-800 placeholder-neutral-400 focus:outline-none focus:border-neutral-400"
          />
        </div>

        {/* Content Body / Live Preview */}
        <div className="pt-4 border-t border-neutral-100">
          {previewMode ? (
            ...
            <textarea
              ...
              placeholder="Tell your story... (Supports Markdown syntax: # Header, ```code, > quote)"
